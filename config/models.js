...
export const imageModels = [
  ...
  { id: "flux-2-pro", label: "Flux 2 Pro", provider: "Flux", tags: ["image", "flagship"] },
  { id: "flux-2-dev", label: "Flux 2 Dev", provider: "Flux", tags: ["image"] },
  { id: "flux-2-flex", label: "Flux 2 Flex", provider: "Flux", tags: ["image"] },
  { id: "flux-2-max", label: "Flux 2 Max", provider: "Flux", tags: ["image", "flagship"] },
  { id: "flux-2-klein-4b", label: "Flux 2 Klein 4B", provider: "Flux", tags: ["image", "fast"] },
  { id: "flux-2-klein-9b", label: "Flux 2 Klein 9B", provider: "Flux", tags: ["image"] },
  { id: "flux-pro-1.1", label: "Flux Pro 1.1", provider: "Flux", tags: ["image"] },
  { id: "flux-1.1-pro-ultra", label: "Flux 1.1 Pro Ultra", provider: "Flux", tags: ["image"] },
  { id: "flux-pro", label: "Flux Pro", provider: "Flux", tags: ["image"] },
  { id: "flux-dev", label: "Flux Dev", provider: "Flux", tags: ["image"] },
  { id: "flux-schnell", label: "Flux Schnell", provider: "Flux", tags: ["image", "fast"] },
  ...
  { id: "flux-kontext-dev", label: "Flux Kontext Dev", provider: "Flux", tags: ["image", "editor"] },
  { id: "flux-depth-dev", label: "Flux Depth Dev", provider: "Flux", tags: ["image", "editor"] },
  { id: "flux-depth-pro", label: "Flux Depth Pro", provider: "Flux", tags: ["image", "editor"] },
  { id: "flux-canny-pro", label: "Flux Canny Pro", provider: "Flux", tags: ["image", "editor"] },
  { id: "flux-canny-dev", label: "Flux Canny Dev", provider: "Flux", tags: ["image", "editor"] },
  { id: "flux-2-pro-editor", label: "Flux 2 Pro (Editor)", provider: "Flux", tags: ["image", "editor"] },
  { id: "flux-2-dev-editor", label: "Flux 2 Dev (Editor)", provider: "Flux", tags: ["image", "editor"] },
  { id: "flux-2-flex-editor", label: "Flux 2 Flex (Editor)", provider: "Flux", tags: ["image", "editor"] },
  { id: "flux-2-max-editor", label: "Flux 2 Max (Editor)", provider: "Flux", tags: ["image", "editor"] },
  { id: "flux-2-klein-4b-editor", label: "Flux 2 Klein 4B (Editor)", provider: "Flux", tags: ["image", "editor", "fast"] },
